...
for (let i = 0; i < questions.length; i++) {
    $('#surveyLocation').append('<div class="form-check">' + '<h3>' + (i+1) + '</h3>' + '<h4>' + questions[i] + '</h4>' + '<input class="form-check-input" type="radio" value="option1" id=' + (i+1) + '>' + '<label class="form-check-label" for=' + (i+1) +'>1</label><input class="form-check-input" type="radio" value="option2" id='+ (i+1) + '>' + '<label class="form-check-label" for=' + (i+1) +'>2</label><input class="form-check-input" type="radio" value="option3" id='+ (i+1) + '>' + '<label class="form-check-label" for='(i+1) +'>3</label><input class="form-check-input" type="radio" value="option4" id='+ (i+1) + '>' + '<label class="form-check-label" for='(i+1) +'>4</label><input class="form-check-input" type="radio" value="option5" id='+ (i+1) + '>' + '<label class="form-check-label" for='(i+1) +'>5</label>' + '</div>');
};

for (let i = 0; i < altQuestions.length; i++) {
    if (i = 0) {
        $('#surveyLocation').append('<div class="form-check">' + '<h3>' + (i+11) + '</h3>' + '<h4>' + altQuestions[0] + '</h4>' + '<input class="form-check-input" type="radio" value="option1" id=' + (i+11) + '>' + '<label class="form-check-label" for=' + (i+11) + '><img src="images/veryhappy.jpg></label><input class="form-check-input" type="radio" value="option2" id=' + (i+11) + '>' + '<label class="form-check-label" for=' + (i+11) + '><img src="images/happy.jpg></label><input class="form-check-input" type="radio" value="option3" id=' + (i+11) + '>' + '<label class="form-check-label" for=' + (i+11) + '><img src="images/normal.jpg></label><input class="form-check-input" type="radio" value="option4" id=' + (i+11) + '>' + '<label class="form-check-label" for=' + (i+11) + '><img src="images/sad.jpg></label><input class="form-check-input" type="radio" value="option5" id=' + (i+11) + '>' + '<label class="form-check-label" for=' + (i+11) + '><img src="images/verysad.jpg></label>' + '</div>');
    }
    else if (i = 1) {
        $('#surveyLocation').append('<div class="form-check">' + '<h3>' + (i+11) + '</h3>' + '<h4' + altQuestions[1] + '</h4>' + '<img src="images/IMG_0995.png">' + '<input class="form-check-input" type="radio" value="option1" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Lawful Good</label><input class="form-check-input" type="radio" value="option2" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Neutral Good</label><input class="form-check-input" type="radio" value="option3" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Choatic Good</label>' + '<input class="form-check-input" type="radio" value="option4" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Lawful Neutral</label><input class="form-check-input" type="radio" value="option5" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>True Neutral</label><input class="form-check-input" type="radio" value="option6" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Chaotic Neutral</label>' + '<input class="form-check-input" type="radio" value="option7" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Lawful Evil</label><input class="form-check-input" type="radio" value="option8" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Neutral Evil</label><input class="form-check-input" type="radio" value="option9" id=' + (i+11) + '<label class="form-check-label" for=' + (i+11) + '>Chaotic Evil</label>');
    }
};
